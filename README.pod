...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Starter-AddModule> or 
L<MetaCPAN|http://www.metacpan.org/module/Module::Starter::AddModule>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Starter-AddModule>

=item *	L<http://www.metacpan.org/module/Module::Starter::AddModule>
